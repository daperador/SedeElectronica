...
public interface AutomotorRepository extends JpaRepository<AutomotorEntity, Long> {
  ...
  public List<DetalleAutomotorDTO> consultarPorId(
      Long idAutomotor, String tipoDocumento, String numeroDocumento);

  @Query(name = "Automotor.consultaSOAT", nativeQuery = true)
  public List<SoatDTO> consultarPorSoat(String placa);

  @Query(name = "Automotor.consultaRTM", nativeQuery = true)
  public List<RtmDTO> consultarPorRTM(String placa);
}
